  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col md:flex-row gap-6 items-start">
        {/* Preview Area */}
        <div className="w-full md:w-48 aspect-square rounded-2xl border-2 border-dashed border-gray-800 bg-gray-950 flex items-center justify-center overflow-hidden group relative">
          {preview ? (
            <>
        ...
        <div className="flex-1 space-y-2">
          <div className="relative">
            ...
            />
            <div className={`px-6 py-3 rounded-xl border border-gray-800 bg-gray-900 text-white font-medium flex items-center justify-center gap-2 transition-all ${uploading ? 'opacity-50' : 'hover:bg-gray-800'}`}>
