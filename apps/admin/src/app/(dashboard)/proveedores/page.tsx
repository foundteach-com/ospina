          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-800 bg-gray-900/50">
                ...
                <th className="px-6 py-4 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">RUC/NIT</th>
            ...
            <tbody className="divide-y divide-gray-800">
              {providers.map((provider) => (
                <tr key={provider.id} className="hover:bg-gray-800/50 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-400">{provider.email}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-400">{provider.phone}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-400">{provider.taxId}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <button onClick={() => handleDelete(provider.id)} className="text-red-400 hover:text-red-300 transition-colors">
