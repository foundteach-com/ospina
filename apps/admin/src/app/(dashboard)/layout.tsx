        ...
        <div className="p-6">
          ...
          <nav className="pb-4">
            <div className="space-y-3">
                          ...
                          return (
                            <li key={item.name} className="space-y-1">
                              <button
                                ...
                                className={`w-full flex items-center justify-between gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all border ${
                                  isAnyChildActive
              ...
              {/* Configuración — sin grupo, debajo de todo */}
              {user.role === 'ADMIN' && (
