...
import { hasAccessToModule } from '@/lib/permissions';
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  // Auto-open Administrador section if on an admin sub-route
  useEffect(() => {
    if (pathname.startsWith('/usuarios') || pathname.startsWith('/roles') || pathname === '/perfil') {
      setAdminOpen(true);
    }
  }, [pathname]);
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 flex">
      <aside className="w-64 border-r border-gray-200 bg-white h-screen sticky top-0 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-1">
          ...
          {hasAccessToModule(user, 'operaciones') && (
            <Link
              href="/operaciones"
              className={`flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all ${
          ...
          {hasAccessToModule(user, 'inventario') && (
            <Link
              href="/inventario"
              className={`flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all ${
                pathname === '/inventario'
          ...
          {hasAccessToModule(user, 'compras') && (
            <Link
              href="/compras"
              className={`flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all ${
                pathname === '/compras'
          ...
          {hasAccessToModule(user, 'proveedores') && (
            <Link
              href="/proveedores"
              className={`flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all ${
          ...
          {hasAccessToModule(user, 'clientes') && (
            <Link
              href="/clientes"
              className={`flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all ${
          ...
          {hasAccessToModule(user, 'flujo-caja') && (
            <Link
              href="/flujo-caja"
              className={`flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all ${
