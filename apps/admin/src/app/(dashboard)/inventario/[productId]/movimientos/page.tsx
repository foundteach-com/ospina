              ...
              {movements.map((movement, index) => (
                <tr key={movement.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-500">
                    ${movement.price.toLocaleString('es-CO', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}
                  </td>
      ...
      {movements.length > 0 && (
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white border border-purple-200 rounded-2xl p-6 shadow-sm">
            ...
            <div className="text-3xl font-bold text-gray-900">
              {balances[0]?.toLocaleString('es-CO', { minimumFractionDigits: 0, maximumFractionDigits: 0 }) || 0}
            </div>
          </div>
        </div>
      )}
