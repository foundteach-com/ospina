          ...
          <div className="space-y-4">
            ...
            <div className="pt-4 border-t border-gray-200 space-y-2">
              ...
              <div className="pt-2 border-t border-gray-100">
                ...
                <div className="text-3xl font-bold text-green-600">${breakdown.totalGross.toLocaleString('es-CO', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <tbody className="divide-y divide-gray-200">
            {sale.items.map((item) => (
              <tr key={item.id} className="text-sm">
                ...
                <td className="px-6 py-4 text-right text-gray-900">${parseFloat(item.salePrice).toLocaleString('es-CO', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</td>
                <td className="px-6 py-4 text-right text-green-600 font-medium">
                  ${(parseFloat(item.quantity.toString()) * parseFloat(item.salePrice)).toLocaleString('es-CO', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}
                </td>
              </tr>
            ))}
          </tbody>
          <tfoot className="bg-gray-50 border-t border-gray-200">
            ...
            <tr className="bg-green-50/50">
              ...
              <td className="px-6 py-4 text-right text-xl font-bold text-green-600">
                ${breakdown.totalGross.toLocaleString('es-CO', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}
              </td>
            </tr>
          </tfoot>
        </table>
