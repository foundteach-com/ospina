...
const contactInfo = [
  {
    title: 'Ubicación',
    description: 'Cra. 14 #24A - 18, Yopal, Casanare',
    link: 'https://maps.google.com/?q=Cra.+14+%2324A+-+18,+Yopal,+Casanare',
    icon: (
  ...
  {
    title: 'Email',
    description: 'lylalmacen777@gmail.com',
    link: 'mailto:lylalmacen777@gmail.com',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    title: 'WhatsApp',
    links: [
      { description: '+57 322 7790154', href: 'https://wa.me/573227790154' },
      { description: '+57 315 1390544', href: 'https://wa.me/573151390544' }
    ],
    icon: (
                    ...
                    <div>
                      ...
                      {info.links ? (
                        <div className="flex flex-col gap-1">
                          {info.links.map((lnk, idx) => (
                            <a key={idx} href={lnk.href} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-700 transition-colors">
                              {lnk.description}
                            </a>
                          ))}
                        </div>
