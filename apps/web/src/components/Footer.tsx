        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-lg font-bold">OSPINA</h3>
                <p className="text-sm text-gray-400">Comercializadora & Suministros</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-blue-700 rounded-lg flex items-center justify-center transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <div className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div>
                  <p className="text-gray-400">Yopal, Casanare</p>
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@ospinacomercializadora.com" className="text-gray-400 hover:text-white transition-colors">
                  info@ospinacomercializadora.com
                </a>
              </li>
            </ul>
          </div>
